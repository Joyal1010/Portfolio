    ...
    <footer id="contact" className="border-t border-neutral-200 dark:border-neutral-800/50 mt-20 transition-colors duration-500">
      <div className="max-w-5xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="text-center md:text-left">
          <h2 className="font-serif text-2xl mb-2 text-neutral-900 dark:text-white transition-colors duration-500">Let's connect</h2>
        ...
        <div className="flex items-center gap-6">
          ...
          <a 
            href="https://github.com/Joyal1010" 
            target="_blank" rel="noopener noreferrer"
            className="text-neutral-600 dark:text-neutral-400 hover:text-black dark:hover:text-white transition-colors p-2 hover:bg-neutral-200 dark:hover:bg-neutral-900 rounded-full"
            aria-label="GitHub"
          >
          ...
          <a 
            href="https://www.linkedin.com/in/joyal-tom-thomas-1b0903313/" 
            target="_blank" rel="noopener noreferrer"
            className="text-neutral-600 dark:text-neutral-400 hover:text-black dark:hover:text-white transition-colors p-2 hover:bg-neutral-200 dark:hover:bg-neutral-900 rounded-full"
            aria-label="LinkedIn"
          >
        ...
        <div className="text-neutral-500 dark:text-neutral-600 text-xs text-center md:text-right transition-colors duration-500">
          <p>&copy; {new Date().getFullYear()} joyaltomthomas.</p>
